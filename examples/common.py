...
def build_env(model: ClaudeModel | None = None) -> dict[str, str]:
    ...
    """
    model_id = (
        model.value if model else os.environ.get("ANTHROPIC_MODEL", "claude-opus-4-6")
    )
    return {
        ...
        # "ANTHROPIC_DEFAULT_OPUS_MODEL": os.environ.get("ANTHROPIC_DEFAULT_OPUS_MODEL", "claude-opus-4-6"),
